...
export const _userList = [...Array(24)].map((_, index) => ({
  ...
  passport: _mock.passport(index),
  faculties: randomInArray([ 'Management', 'IT', 'Computer Sience', 'Music']),
  ...
  status: randomInArray(['success', 'failed']),
  studyType: randomInArray(['sirtqi', 'kunduzgi']),
  role: randomInArray(['Grant', 'Kontrakt']),
  ball: randomNumberRange(1, 189),
}));